...
namespace Roommates.Repositories
{
    ...
    public class RoomRepository : BaseRepository
    {
        ...
        /// </summary>
        /// <param name="id">The ID of the Room you're retrieving from the DB.</param>
        /// <returns>A single Room class object</returns>
        public Room GetById(int id)
        {
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    //using interpolation with SQL is bad, it allows for many possible problems such as SQL injection
